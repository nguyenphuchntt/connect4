...
class OpeningBook {
  TableGetter<Board::position_t, uint8_t> *T;
  const int width;
  const int height;
  int depth;

  template<class partial_key_t>
  TableGetter<Board::position_t, uint8_t>* initTranspositionTable(int log_size) {
    switch(log_size) {
    case 21:
      return new TranspositionTable<partial_key_t, Board::position_t, uint8_t, 21>();
    case 22:
      return new TranspositionTable<partial_key_t, Board::position_t, uint8_t, 22>();
    case 23:
      return new TranspositionTable<partial_key_t, Board::position_t, uint8_t, 23>();
    case 24:
      return new TranspositionTable<partial_key_t, Board::position_t, uint8_t, 24>();
    case 25:
      return new TranspositionTable<partial_key_t, Board::position_t, uint8_t, 25>();
    case 26:
      return new TranspositionTable<partial_key_t, Board::position_t, uint8_t, 26>();
    case 27:
      return new TranspositionTable<partial_key_t, Board::position_t, uint8_t, 27>();
    default:
  ...
  TableGetter<Board::position_t, uint8_t>* initTranspositionTable(int partial_key_bytes, int log_size) {
 ...
 public:
  ...
  OpeningBook(int width, int height, int depth, TableGetter<Board::position_t, uint8_t>* T) : T{T}, width{width}, height{height}, depth{depth} {} // Empty opening book
  /**
